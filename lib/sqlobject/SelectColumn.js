...
Object.setPrototypeOf(SelectColumn.prototype, Serializable.prototype);

SelectColumn.prototype._serialize = function(ctx) {
  const self = this;
  const o = {
    schema: this.schema,
    table: this.table,
  ...
  return Serializable.serializeFallback(ctx, 'select_column', o, function() {
