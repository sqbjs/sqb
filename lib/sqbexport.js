...
const Select = require('./query/selectquery');
const Insert = require('./query/insertquery');
const Update = require('./query/updatequery');
const Delete = require('./query/deletequery');
