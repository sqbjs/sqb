...
class Generator {
    ...
    constructor(config) {
        ...
        this.prettyPrint = !config || config.prettyPrint === undefined || !!config.prettyPrint;
        this.namedParams = !config || config.namedParams === undefined || !!config.namedParams;
        if (config) {
            this.inputParams = config.params
        } else this.inputParams = {};
    ...
    _generateJoin(join) {
        ...
        else if (join.table.type === 'select') {
