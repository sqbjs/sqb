...
class DatasetStream extends Readable {
  ...
  constructor(dataset, options) {
    ...
    typeof options.stringify === 'function' ? options.stringify :
        function stringify(obj) {
          return DatasetStream.defaultStringify(obj);
        };
...
DatasetStream.defaultStringify = function(obj) {
